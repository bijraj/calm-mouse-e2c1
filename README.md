...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/calm-mouse-e2c1
```

A live public deployment of this template is available at [https://calm-mouse-e2c1.templates.workers.dev](https://calm-mouse-e2c1.templates.workers.dev)
